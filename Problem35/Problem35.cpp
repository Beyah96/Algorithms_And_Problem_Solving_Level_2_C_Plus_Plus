...
bool IsNumberInArray(int Arr[100], int Length, int SearchedNumber) {
	return SearchNumberInArray(Arr, Length, SearchedNumber);
}
void PrintSerchedNumber(int Arr[100], int Length, int SearchedNumber) {
	bool Found = IsNumberInArray(Arr, Length, SearchedNumber);
	if (Found)
